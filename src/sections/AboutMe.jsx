...
import myImage from '../assets/image/pic2.jpg';
const AboutMe = () => {
    return (
        <>
            {/* Heading */}
            ...
            <section className="bg-[#111111] lg:px-16  md:pt-10 pt-24 md:px-20 px-8 " >
                ...
                <div className="w-full h-full relative top-5 pb-20">
                    <div className=" flex sm:flex-row flex-col-reverse gap-6 justify-center items-center">
                        <div className="sm:text-left text-center text-white">
                            ...
                            <div className=" mt-6 flex sm:flex-row flex-col gap-4 sm:justify-start justify-center">
                                <a
                                    ...
                                    download="ChhenglySiek-CV.pdf" // Desired name for the downloaded file
                        ...
                        {/* Image */}
                        <img className="md:max-w-[30%] sm:max-w-[40%] max-w-[70%] sm:rounded-sm sm:rounded-br-[5rem] sm:rounded-tl-[5rem] rounded-full sm:outline-none outline outline-[.3rem] outline-pink-400/60 shadow-lg shadow-pink-200/60" src={myImage} alt="My Pic" />
